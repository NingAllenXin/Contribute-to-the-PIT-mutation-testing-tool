...
public class MinusAfterLoad implements MethodMutatorFactory {

    @Override
    public MethodVisitor create(MutationContext context, MethodInfo methodInfo, MethodVisitor methodVisitor) {
        return new MinusAfterLoadVisitor(this, context, methodVisitor);
    }
...
class MinusAfterLoadVisitor extends MethodVisitor {
    
    private final MethodMutatorFactory factory;
    private final MutationContext      context;
    
    MinusAfterLoadVisitor (final MethodMutatorFactory factory,
