...
public class AddBeforeLoad implements MethodMutatorFactory {

    @Override
    public MethodVisitor create(MutationContext context, MethodInfo methodInfo, MethodVisitor methodVisitor) {
        return new AddBeforeLoadVisitor(this, context, methodVisitor);
    }
...
class AddBeforeLoadVisitor extends MethodVisitor {
    
    private final MethodMutatorFactory factory;
    private final MutationContext      context;
    
    AddBeforeLoadVisitor (final MethodMutatorFactory factory,
